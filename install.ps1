...
$files = @('package.json', 'cordis.patch.yml', 'index.mjs', 'config.mjs', 'safety.mjs', 'title.mjs', 'registry.mjs', 'family.mjs', 'feedback.mjs', 'external.mjs', 'i18n.mjs', 'ops.mjs', 'tools.mjs', 'commands.mjs', 'skills.mjs', 'client.js', 'README.md')
